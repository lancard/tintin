...
extern void substitute_myvariables(const char *arg, char *result, struct session *ses);
extern void getvarvalue_command(const char *arg, struct session *ses);
...
extern void postpad_command(const char *arg, struct session *ses);
extern void prepad_command(const char *arg, struct session *ses);
extern void removestring_command(const char *arg, struct session *ses);
#endif
